...
import { clearArticleContent } from "./clearArticleContent";
import fs from "node:fs";

const content = fs.readFileSync('./test/fixtures/finance.yahoo.md', 'utf8');

const clearContent = `### Key Takeaways
...
const source: Source = "finance.yahoo";

test('yahoo clears article content', () => {
  expect(clearArticleContent(content, source)).toBe(clearContent)
})